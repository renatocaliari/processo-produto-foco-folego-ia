...
se você utiliza uma tecnologia social como [contornos](https://calirenato82.substack.com/p/e-book-contornos-tecnologia-social), [o2 (organização orgânica)](https://medium.com/tentaculus/o-que-s%c3%a3o-as-organiza%c3%a7%c3%b5es-org%c3%a2nicas-e37621708586), sabe que possivelmente uma pessoa pode energizar mais de um contorno ou [papel](https://o2.targetteal.com/meta-acordos#2-1-papeis).
...
agora, a pessoa que está sendo avaliada, cria uma proposta de plano de ação com las ações que explorou no passo anterior. ela pode pedir ajuda a uma pessoa que tenha experiência nesses papéis ou alguém que ela confia.
...
## **auto-reflexão-avaliação**

*(inspirado [nesse exercício](https://buster.substack.com/p/whats-the-first-big-thing-youd-like) e no texto* [the six sources of influence on human behaviour](https://vitalsmarts.com.au/six-sources-influence-human-behaviour/)*)*
...
lembre-se da importância e critérios para [**dados variados**](https://calirenato82.substack.com/i/141675016/dados-variados). para produzir variação nos dados, **crie questões que contenham palavras extremas com rubrica e escala adequada**.
...
veja o artigo [reinventing performance management](https://webcache.googleusercontent.com/search?channel=fs&client=ubuntu&q=cache%3Ahttps%3A%2F%2Fhbr.org%2F2015%2F04%2Freinventing-performance-management) para ver possibilidades de como utilizar e analisar os dados obtidos através dessas perguntas.

## **grupo para avaliar situação de parceria entre pessoas colaboradoras**

para decisões críticas como demissões, ou mesmo salário, sua organização pode ter um círculo para tomar essas decisões de forma transparente. veja mais sobre [círculo de parceiros](https://targetteal.com/pt/blog/circulo-de-parceiros/) no blog da [target teal](https://targetteal.com/pt/blog/).
...
abaixo fiz uma tradução livre das declarações em inglês ([veja o original aqui](https://www.tmbc.com/portfolio-item/engagement-pulse-team-leader-effectiveness-through-the-eyes-of-employees/)):
...
habilite uma plataforma na qual as pessoas possam mostrar interesse comum e potencialize discussões e aprendizados por lá. como aditivo, pesquise por [working out loud](https://workingoutloud.com/en/for-you) ou [action-learning](https://www.wial.org.br/)**.**
